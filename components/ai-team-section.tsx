                        ...
                        <div className="bg-slate-900 px-6 py-4 text-white">
                          <div className="flex items-center gap-3">
                            <img
                              ...
                              alt="Michael - Agente de IA Marketing Digital Tijuana"
                        ...
                        >
                          {displayedMessages.map((message, index) => (
                            ...
                            >
                              {message.sender === "ai" && (
                                <img
                                  src="/images/michael-ai-agent.jpg"
                                  alt="Michael - Asistente de IA para Marketing Digital"
                                  className="w-6 h-6 rounded-full object-cover mr-2 mt-1 shrink-0"
                                />
                              )}
                              <div
                                className={`max-w-[80%] p-3 rounded-2xl text-sm leading-relaxed ${message.sender === "customer"
                          ...
                          {isTyping && (
                            <div className="flex justify-start items-start">
                              <img
                                src="/images/michael-ai-agent.jpg"
                                alt="Michael - Agente IA para Marketing Digital en Tijuana"
                                className="w-6 h-6 rounded-full object-cover mr-2 mt-1 shrink-0"
                              />
