...
const AnimatedEmailDemo = ({ isActive }: { isActive: boolean }) => {
  const [emails, setEmails] = useState([
    ...
    { subject: "Presupuesto solicitado", status: "unread" },
  ]);
...
const features = [
  {
    title: "Soporte de Agente IA 24/7",
    description:
      "Agentes inteligentes que gestionan consultas de clientes, responden preguntas y capturan leads en tu sitio web y canales sociales.",
  ...
  },
  {
    ...
    description:
      "Agentes de email potenciado por IA que responde consultas, proporciona información y deriva consultas complejas a tu equipo.",
