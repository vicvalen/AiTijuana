...
export const metadata: Metadata = {
  title: "Soluciones de Performance Marketing | HighRank Funnel",
  description: "Paquetes diseñados para maximizar tu ROI. Soluciones especializadas en Google Ads, Meta Ads y funnels de conversión con precios transparentes y resultados garantizados.",
};
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import Aurora from "@/components/Aurora";
import { Check, ArrowRight, Star, Phone, Mail, Calendar, BarChart3, Search, Target, TrendingUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-background-primary relative overflow-hidden">
      ...
      <section className="relative z-10 pt-32 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-accent-primary/20 backdrop-blur-md border border-accent-primary/30 text-text-primary text-sm font-medium mb-8">
      ...
      <section className="relative z-10 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="bg-background-card/80 backdrop-blur-md border border-accent-primary overflow-hidden">
            <CardContent className="p-12">
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
                ¿Listo para elegir tu paquete?
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="bg-highlight-gradient hover:opacity-90 text-text-on-accent rounded-full px-8 py-3 text-lg">
                  Consulta Gratuita
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                
                <Button variant="outline" className="border-accent-primary text-accent-primary hover:bg-accent-primary hover:text-text-on-accent rounded-full px-8 py-3 text-lg">
