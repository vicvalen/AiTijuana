...
export function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      text: "Gastamos mucho menos tiempo en gestionar respuestas a clientes potenciales gracias al compromiso instantáneo que nos ofrece Ai-Studio.",
      name: "Sarah Chen",
      role: "Gerente de ventas",
    },
    {
      text: "Con Ai-Studio, nuestras tasas de conversión aumentaron un 85% y los ingresos de fin de semana crecieron un 40%.",
      name: "Michael Torres",
    ...
    {
      text: "Los puntajes de satisfacción del cliente mejoraron notablemente desde que implementamos Ai-Studio. A los clientes les encantan las respuestas instantáneas y las recomendaciones personalizadas.",
      name: "David Kim",
      role: "Gerente de experiencia del cliente",
    },
    {
      text: "Nuestra tienda minorista vio un aumento del 60% en clientes potenciales calificados. El Agente gestiona las consultas de producto mientras nosotros nos concentramos en la atención presencial.",
      name: "Lisa Thompson",
      role: "Gerente de tienda",
    },
    {
      text: "Las consultas inmobiliarias ahora se gestionan al instante. Cerramos 3 veces más operaciones desde que implementamos el asistente IA de Ai-Studio.",
      name: "James Wilson",
