...
export function ROICalculatorSection() {
  ...
  const getBusinessDefaults = () => {
    ...
    return (
      businessDefaults[inputs.businessType as keyof typeof businessDefaults] ||
  ...
  // Métricas mejoradas con el chatbot de IA
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto text-balance">
            Calcula cuántos ingresos adicionales podría generar tu negocio con
              ...
              <div className="space-y-8 flex-1">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setInputs((prev) => ({ ...prev, businessType: value }))
                    }
                  >
                    ...
                    <SelectContent className="bg-gray-800 border-gray-700">
                      ...
                      <SelectItem value="realestate">Bienes Raíces</SelectItem>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-3">
                    Visitantes Mensuales al Sitio Web:{" "}
                ...
                <div>
                  ...
                  <Slider
                    ...
                    min={25}
                    step={
                      inputs.businessType === "automotive" ||
                      inputs.businessType === "realestate"
                        ? 1000
                        : 25
                    }
                    className="w-full"
              ...
              <div className="mt-6 lg:hidden">
                <div className="flex items-center justify-center gap-2 p-3 rounded-lg bg-primary/10 border border-primary/20">
                  ...
                  <span className="text-sm text-primary font-medium">
                    Desplázate hacia abajo para ver tus resultados
                  </span>
                </div>
              </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          ...
                          Las empresas ven un {businessConfig.conversion}% de
                          aumento en conversiones en 30 días
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          ...
                          Los chatbots de IA responden {businessConfig.response}
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          ...
                          Aumenta {businessConfig.satisfaction}% con soporte de
                          IA 24/7
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <span className="text-lg md:text-xl font-bold text-white">
                      {improvements.response}% más rápido
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-6 md:mt-8 p-4 md:p-6 rounded-lg bg-white/5 border border-white/10">
                  <div className="text-center">
                    <div className="text-xs md:text-sm text-gray-300 mb-2">
                      Aumento Anual Proyectado de Ingresos
                    </div>
                    <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2">
                      ${(additionalRevenue * 12).toLocaleString()}
                    </div>
                    <div className="text-xs md:text-sm text-gray-400">
                      Basado en tus métricas actuales y referencias de la
                      industria
                    </div>
                  </div>
                </div>
        ...
        >
          <p className="text-sm text-gray-400 mt-4">
            * Resultados basados en promedios de la industria y pueden variar
            por negocio
          </p>
        </div>
      </div>
