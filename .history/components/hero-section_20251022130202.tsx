    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-accent-primary/20 backdrop-blur-md border border-accent-primary/30 text-text-primary text-sm font-medium mb-8 mt-12 animate-fade-in-badge">
          ...
          🚀 Marketing Digital con Inteligencia Artificial en Tijuana
        </div>

        {/* Main Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6 animate-fade-in-heading">
          <span className="text-text-primary">Agencia de Marketing Digital con IA en Tijuana</span>
          <br />
          <span className="inline-flex items-center justify-center flex-wrap gap-2 mt-4 sm:mt-6 md:mt-8">
            <span className="text-text-primary">Transforma tu</span>
              <RotatingText
              texts={[
                "Crecimiento",
                "Innovación",
        ...
        <p className="text-base sm:text-xl md:text-2xl text-text-secondary text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          Agencia líder en Marketing Digital e Inteligencia Artificial en Tijuana.
          Transformamos tu negocio con chatbots inteligentes, automatización de procesos
          y estrategias digitales innovadoras para maximizar tu ROI.
        </p>
